...
void Node::LaserScanCallback(::cartographer_generic_msgs::LaserScan::ConstPtr& msg, const int trajectory_id ){
...
void Node::OdometryCallback( ::cartographer_generic_msgs::Odometry::ConstPtr& msg, const int trajectory_id ){
