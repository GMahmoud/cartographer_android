...
void protobuf_AssignDesc_cartographer_2fmapping_5f3d_2fproto_2frange_5fdata_5finserter_5foptions_2eproto() {
  protobuf_AddDesc_cartographer_2fmapping_5f3d_2fproto_2frange_5fdata_5finserter_5foptions_2eproto();
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_cartographer_2fmapping_5f3d_2fproto_2frange_5fdata_5finserter_5foptions_2eproto);
}
...
void protobuf_ShutdownFile_cartographer_2fmapping_5f3d_2fproto_2frange_5fdata_5finserter_5foptions_2eproto() {
  delete RangeDataInserterOptions::default_instance_;
  delete RangeDataInserterOptions_reflection_;
}

void protobuf_AddDesc_cartographer_2fmapping_5f3d_2fproto_2frange_5fdata_5finserter_5foptions_2eproto() {
  ...
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_cartographer_2fmapping_5f3d_2fproto_2frange_5fdata_5finserter_5foptions_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_cartographer_2fmapping_5f3d_2fproto_2frange_5fdata_5finserter_5foptions_2eproto {
  StaticDescriptorInitializer_cartographer_2fmapping_5f3d_2fproto_2frange_5fdata_5finserter_5foptions_2eproto() {
    protobuf_AddDesc_cartographer_2fmapping_5f3d_2fproto_2frange_5fdata_5finserter_5foptions_2eproto();
  }
} static_descriptor_initializer_cartographer_2fmapping_5f3d_2fproto_2frange_5fdata_5finserter_5foptions_2eproto_;
...
const RangeDataInserterOptions& RangeDataInserterOptions::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_cartographer_2fmapping_5f3d_2fproto_2frange_5fdata_5finserter_5foptions_2eproto();
...
void RangeDataInserterOptions::MergeFrom(const RangeDataInserterOptions& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_num_free_space_voxels()) {
